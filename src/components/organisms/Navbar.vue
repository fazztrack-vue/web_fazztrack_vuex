    ...
    <nav :class="widhtContain === 'profile' ? 'container-profile container bg-white flex items-center' : 'container-class bg-white flex items-center'">
          ...
          <main class="flex flex-1 justify-between items-center">
            <section class="flex justify-between items-center font-bold gap-5">
                  ...
                  <section class="flex">
                    ...
                    <section class="flex">
                      ...
                      <section>
                        ...
                        <section class="flex flex-col items-start gap-[6px]">
                          <a @click="moveRoute('/about')" rel="noopener noreferrer" class="flex items-center font-bold whitespace-nowrap py-[4px]">Sekilas Fazztrack</a>
                        </section>
                      </section>
                    </section>
                  </section>
              ...
              <div @click="moveRoute('/hire')" class="font-bold cursor-pointer">
